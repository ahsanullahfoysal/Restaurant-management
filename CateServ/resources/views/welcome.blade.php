@extends('layout')
@section('title')
Coran || Responsive HTML 5 Template
@endsection
...
<div class="container-fluid bg-light py-6 my-6 mt-0">
           <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-7 col-md-12">
                        <small class="d-inline-block fw-bold text-dark text-uppercase bg-light border border-primary rounded-pill px-4 py-1 mb-4 animated bounceInDown">{{$slider->name}}</small>
                        <h1 class="display-1 mb-4 animated bounceInDown">{{$slider->title}}</h1>
                        <a href="" class="btn btn-primary border-0 rounded-pill py-3 px-4 px-md-5 me-4 animated bounceInLeft">{{$slider->btn1}}</a>
                        <a href="" class="btn btn-primary border-0 rounded-pill py-3 px-4 px-md-5 animated bounceInLeft">{{$slider->btn2}}</a>
                    </div>
                    <div class="col-lg-5 col-md-12">
                        <img src="{{asset('pictures/'. $slider->photo)}}" class="img-fluid rounded animated zoomIn" alt="">
                    </div>
                </div>
            </div> 
        </div>
                            ...
                            <div class="bg-light rounded service-item">
                                <div class="service-content d-flex align-items-center justify-content-center p-4">
                                    <div class="service-content-icon text-center">
                                        ...
                                        <img src="{{asset('pictures/'. $o->photo) }}" alt="image"  height="150px" width="200px">
                                        <h4 class="mb-3">{{$o->title}}</h4>
                                        <p class="mb-4">{{$o->details}}</p>
                                        <a href="#" class="btn btn-primary px-4 py-2 rounded-pill">{{$o->btn}}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-6 col-lg-3 wow bounceInUp" data-wow-delay="0.1s">
                                            <div class="event-img position-relative">
                                                <img class="img-fluid rounded w-100" src="{{asset('pictures/'. $e->photo) }}" alt="">
                                                <div class="event-overlay d-flex flex-column p-4">
                                                    <h4 class="me-auto">{{$e->title}}</h4>
                    ...
                    <div class="tab-content">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-lg-6 wow bounceInUp" data-wow-delay="0.1s">
                                    <div class="menu-item d-flex align-items-center">
                                        <img class="flex-shrink-0 img-fluid rounded-circle" src="{{asset('pictures/'. $m->photo) }}" alt="">
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <div class="d-flex justify-content-between border-bottom border-primary pb-2 mb-2">
                                                <h4>{{$m->title}}</h4>
                                                <h4 class="text-primary">${{$m->price}}</h4>
                                            </div>
                                            <p class="mb-0">{{$m->details}}</p>
                                        </div>
                                    </div>
                                </div>
                                @endforeach        
                        ...
                        <div id="tab-7" class="tab-pane fade show p-0">
                            <div class="row g-4">
                                <div class="col-lg-6">
                                    <div class="menu-item d-flex align-items-center">
                                        <img class="flex-shrink-0 img-fluid rounded-circle" src="{{asset('/assetsimg/menu-01.jpg')}}" alt="">
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <div class="d-flex justify-content-between border-bottom border-primary pb-2 mb-2">
                                                <h4>Argentinian</h4>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-5 wow bounceInUp" data-wow-delay="0.1s">
                        <img src="{{asset('pictures/'. $about->photo)}}" class="img-fluid rounded" alt="Image">
                    </div>
                    <div class="col-lg-7 wow bounceInUp" data-wow-delay="0.3s">
                        ...
                        <div class="row g-4 text-dark mb-5">
                            <div class="col-sm-6">
                                <i class="fas fa-share text-primary me-2"></i>{{$about->service1}}
                            </div>
                            <div class="col-sm-6">
                                <i class="fas fa-share text-primary me-2"></i>{{$about->service2}}
                            </div>
                            <div class="col-sm-6">
                                <i class="fas fa-share text-primary me-2"></i>{{$about->service3}}
                            </div>
                            <div class="col-sm-6">
                                <i class="fas fa-share text-primary me-2"></i>{{$about->service4}}
                            </div>
                        </div>
        ...
        <div class="container-fluid py-6">
            <div class="container">
                <div class="text-center wow bounceInUp" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: bounceInUp;">
                    <small class="d-inline-block fw-bold text-dark text-uppercase bg-light border border-primary rounded-pill px-4 py-1 mb-3">Testimonial</small>
                    <h1 class="display-5 mb-5">What Our Customers says!</h1>
                </div>
                <div class="owl-carousel owl-theme testimonial-carousel testimonial-carousel-1 mb-4 wow bounceInUp owl-loaded" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: bounceInUp;">
                    
                    
                    
                    
                <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-960.999px, 0px, 0px); transition: all 10s linear 0s; width: 3203.33px;"><div class="owl-item cloned" style="width: 295.333px; margin-right: 25px;"><div class="testimonial-item rounded bg-light">
                    ...
                    </div></div><div class="owl-item cloned" style="width: 295.333px; margin-right: 25px;"><div class="testimonial-item rounded bg-light">
                        <div class="d-flex mb-3">
                    ...
                    </div></div><div class="owl-item active" style="width: 295.333px; margin-right: 25px;"><div class="testimonial-item rounded bg-light">
                        <div class="d-flex mb-3">
                    ...
                    </div></div></div></div><div class="owl-controls"><div class="owl-nav"><div class="owl-prev" style="display: none;">prev</div><div class="owl-next" style="display: none;">next</div></div></div><div class="owl-dots" style="display: none;"></div></div>
                <div class="owl-carousel testimonial-carousel testimonial-carousel-2 wow bounceInUp owl-theme owl-rtl owl-loaded" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: bounceInUp;">
                    
                    
                    
                    
                <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(960.999px, 0px, 0px); transition: all 10s linear 0s; width: 3203.33px;"><div class="owl-item cloned" style="width: 295.333px; margin-left: 25px;"><div class="testimonial-item rounded bg-light">
                        <div class="d-flex mb-3">
                            <img src="{{asset('assets/img/testimonial-2.jpg')}}" class="img-fluid rounded-circle flex-shrink-0" alt="">
                            <div class="position-absolute" style="top: 15px; right: 20px;">
                                <i class="fa fa-quote-right fa-2x"></i>
                    ...
                    </div></div><div class="owl-item cloned" style="width: 295.333px; margin-left: 25px;"><div class="testimonial-item rounded bg-light">
                        <div class="d-flex mb-3">
                            <img src="{{asset('assets/img/testimonial-3.jpg')}}" class="img-fluid rounded-circle flex-shrink-0" alt="">
                            <div class="position-absolute" style="top: 15px; right: 20px;">
                                <i class="fa fa-quote-right fa-2x"></i>
                    ...
                    </div></div><div class="owl-item active" style="width: 295.333px; margin-left: 25px;"><div class="testimonial-item rounded bg-light">
                        <div class="d-flex mb-3">
                            <img src="{{asset('assets/img/testimonial-1.jpg')}}" class="img-fluid rounded-circle flex-shrink-0" alt="">
                            <div class="position-absolute" style="top: 15px; right: 20px;">
                                <i class="fa fa-quote-right fa-2x"></i>
           ...
           <div class="container-fluid faqt py-6">
            <div class="container">
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-lg-5 wow bounceInUp" data-wow-delay="0.1s">
                        <div class="video">
                            <button type="button" class="btn btn-play" data-bs-toggle="modal" data-src="https://youtu.be/WdWEMXnHBVI" data-bs-target="#videoModal">
                                <span></span>
                            </button>
                        </div>
                    </div>
